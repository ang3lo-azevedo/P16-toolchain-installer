...
cls && echo A instalar Microsoft Visual C++ Redistributable para Visual Studio 2019
...
cls && echo A criar pasta p16as
mkdir p16as

cls && echo A criar pasta p16dbg
mkdir p16dbg

cls && echo A criar pasta p16sim
mkdir p16sim
...
cls && echo A obter ficheiros do p16db, a extrair e eliminar o zip
cd ..\p16dbg
...
cls && echo A adicionar os caminhos à variável de ambiente PATH
