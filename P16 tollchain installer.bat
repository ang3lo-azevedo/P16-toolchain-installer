...
cls && echo A transferir e instalar o Microsoft Visual C++ Redistributable para Visual Studio 2019 && echo.
curl https://aka.ms/vs/17/release/vc_redist.x86.exe -JLO && vc_redist.x86.exe -q -norestart && del vc_redist.x86.exe

cls && echo A tranferir e instalar a framework .NET da Microsoft && echo.
curl https://go.microsoft.com/fwlink/?LinkId=2085155 -JLo ndp48-web.exe && ndp48-web.exe -q -norestart && del ndp48-web.exe

cls && echo A criar pasta p16as && echo.
mkdir p16as

cls && echo A criar pasta p16dbg && echo.
mkdir p16dbg

cls && echo A criar pasta p16sim && echo.
mkdir p16sim

cls && echo A obter ficheiros do p16sim, a extrair e eliminar o zip && echo.
cd p16as
...
cls && echo A obter ficheiros do p16db, a extrair e eliminar o zip && echo.
cd ..\p16dbg
...
cls && echo A adicionar os caminhos à variável de ambiente PATH && echo.
