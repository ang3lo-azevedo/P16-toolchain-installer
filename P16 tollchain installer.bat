...
cls && echo. && echo A criar pasta p16as
mkdir p16as

cls && echo. && echo A criar pasta p16dbg
mkdir p16dbg

cls && echo. && echo A criar pasta p16sim
mkdir p16sim

cls && echo. && echo A obter ficheiros do p16sim, a extrair e eliminar o zip
cd p16as
...
cls && echo. && echo A obter ficheiros do p16db, a extrair e eliminar o zip
cd ..\p16dbg
...
cls && echo. && echo A adicionar os caminhos à variável de ambiente PATH
